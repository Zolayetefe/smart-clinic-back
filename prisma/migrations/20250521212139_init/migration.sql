/*
  ...
  - The values [confirmed] on the enum `LabRequestStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "LabRequestStatus_new" AS ENUM ('requested', 'completed');
